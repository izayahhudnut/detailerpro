...
-- Simple RLS policies
CREATE POLICY "Allow all on organizations" ON organizations FOR ALL TO public USING (true);
CREATE POLICY "Allow all on users" ON users FOR ALL TO public USING (true);

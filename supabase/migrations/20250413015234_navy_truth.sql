...
-- Update other tables' RLS policies to allow public access
...
-- Ensure job_inventory table exists and has public access
...
DROP POLICY IF EXISTS "Allow all operations" ON job_inventory;
CREATE POLICY "Allow all operations"
